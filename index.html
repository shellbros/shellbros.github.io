...
<script>window.JSCDN="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/";</script>
<script src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/app/checker.js"></script>
<script>
    let HouseAds;
    var shellLogo = 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/logo.svg';

    async function getAds() {
        const response = await fetch(dynamicContentPrefix + 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/data/housePromo.json?' + Date.now());
	...
	class Loader {
		...
		static _jscdnFallback = 'https://cdn.jsdelivr.net/gh/shellbros/mathlete/';
		...
		static _validateUrl(url) {
			...
			return lower.includes('cdn.jsdelivr.net') && (lower.includes('apstudy/mathlete') || lower.includes('shellbros/mathlete') || lower.includes('shellbros/shellbros'));
		}
		...
		static loadJS(path, callback) {
			this._waitForJSCDN(() => {
				this._doLoadJS(path, callback);
			});
		}

		static _doLoadJS(path, callback) {
			const p = this._resolveurl(path);
			if (!p) {
				console.error('[Loader] Aborting load, invalid path:', path);
				return;
			}
			...
			(function(url, cb) {
				...
				xhr.onload = () => {
					if (xhr.status != 200) {
						...
						const wasmUrl = Loader._resolveurl('js/wasm_loader.js');
						if (!wasmUrl) {
							console.error('[Loader] Failed to resolve wasm_loader URL');
							return;
						}
    ...
    // Loader.blueWizSrcAlt = 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/blueWizard_logo_borg.webp';
    Loader.show();
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/styles/style.min.css?1772720255"><script>
...
<!-- VueJS -->
<script src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/js/vue/vue2.6.10.js"></script><!-- tools and varibles -->
...
<script>
	...
	let loaderInterval = setInterval(() => {
		if (window.Loader) {
			...
			Loader.loadJS('js/screenShot.js');
			Loader.loadJS('js/shellshock.js', ssJSComplete);
		}
	}, 100);
	// CDN-IGNORE-END
...
<!-- <div class="video_ad_wrapper">
    <video id="asc_video_ad" class="video-js vjs-default-skin" controls preload="auto" width="640" height="360" muted="true" style="display: none;">
        <source src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/video/tiny.mp4" type="video/mp4" />
    </video>
</div> -->
    ...
    <div id="gameDescription" v-show="(showScreen === screens.home)">
        ...
        <section class="game-info">
            ...
            <section class="text-center">
                <p>{{ loc.home_blocked_start }} shellshockers.wiki {{ loc.home_blocked_end }}</p>
            </section>
    ...
    <!-- <img v-if="blackFridayBanner" class="black-friday-banner" style="display: none" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/black-friday-banner.jpg" alt="Black Friday Sale"/> -->
    ...
    <small-popup v-if="isAnonymous" id="anonWarningPopup" ref="anonWarningPopup" :hide-close="true" :overlay-close="false" @popup-cancel="anonWarningPopupCancel" @popup-confirm="anonWarningPopupConfrim">
        <template slot="header"><img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_goldenEgg.svg" class="egg_icon" />{{ loc.account_anon_warn_popup_title }}! <img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_goldenEgg.svg" class="egg_icon" /></template>
        <template slot="content">
    ...
    <!-- <large-popup ref="kotcInstrucPopup" id="kotcInstrucPopup" :overlay-close="true" hide-confirm="true" hide-cancel="true">
        <template slot="content">
            <img class="kotc-wordmark" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/kotc-wordmark.svg" alt="">
            <div class="kotc-how-to-play-wrapper box_absolute">
                ...
                <img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/kotc-arrow.svg" aria-hidden="true">
            </div>
            ...
            <div class="display-grid grid-column-2-eq grid-gap-space-lg roundme_md fullwidth ss_margintop_lg kotc-play-now step-three-wrapper">
                <div class="fullwidth box_relative step-three">
                    <img class="kotc-logo box_absolute" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/kotc-rooster.svg" alt="The King of the Coop Rooster">
                ...
                <div class="fullwidth f_col f_space_between">
                    ...
                    <img aria-hidden="true" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/kotc-crown.svg" alt="Crowns">
                    <img aria-hidden="true" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/kotc-crown.svg" alt="Crowns">
                    <img aria-hidden="true" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/kotc-crown.svg" alt="Crowns">
                    <img aria-hidden="true" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/kotc-crown.svg" alt="Crowns">
                    <img aria-hidden="true" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/kotc-crown.svg" alt="Crowns">
...
-->
    ...
    <!-- <div id="kotc-play-kotc" class="kotc-play-kotc display-grid">
		<img class="kotc-play-kotc-watermark" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/kotc-crown-indicator.svg" alt="">
		<img class="kotc-play-kotc-arrow" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/kotc-arrow.svg" aria-hidden="true">
	</div> -->
    <!-- #kotc-play-kotc -->
    ...
    <large-popup id="chromeIsABuggerPopup" ref="chromeIsABuggerPopup" :overlay-close="false">
        <template slot="content">
            ...
            <div class="display-grid grid-column-2-eq">
                <img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chromeIsABuggerPopup-guide-1.webp" alt="chrome guide 1 how to give shell mouse control">
                <img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chromeIsABuggerPopup-guide-2.webp" alt="chrome guide 2 how to give shell mouse control">
            </div>
        </template>
    </large-popup>
...
<script>
    ...
    ui: {
		...
		lazyImages: {
			homeEgg1: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/eggPose05.webp',
			homeEgg2: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/eggPose01.webp',
			vipEmblem: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/vip-club/vip-club-popup-emblem.webp',
			vipPayment: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/store/UI_paymentOptions.webp',
			vipPopupBg: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/vip-club/vip-club-popup-background.webp',
			chwPopup: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/ssAd_chicknWinner800x600-min.webp',
			rickRoll: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/rickroll.gif',
			adBlockPopup: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/shellshockers-unite-lg.webp',
			vipImportant: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/vip-club/very-important-poultry.webp',
			eggPackSm: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/egg_pack_small.webp',
			goldenEgg: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_goldenEgg.svg',
			eggOrgGiveStuff: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/egg-org/eggOrg_timeTravel_splash800x600-min.webp',
			welcomePack: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/eggstra-value-pack.webp',
			welcomePackPopup: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/welcome-pass-popup.webp',
			kotcArrow: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/kotc-arrow.svg',
			chwChest: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/chicken-nugget/chw-loot-btn.webp'
		},
    ...
    music: {
        isMusic: false,
        musicJson: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/data/sponsors.json',
        musicSrc: '',
        theAudio: '',
        playing: false,
        sponsors: {},
	...
	hvsm: {
		hero: {
			name: 'Heroes',
			items: [],
			img: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/shell_E&E_good_popup.webp',
		},
		monster: {
			name: 'Monsters',
			items: [],
			img: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/shell_E&E_evil_popup.webp',
		},
	},
    ...
    controllerButtonIcons: {
        xbox: [
            ...
            'Select',
            'Start',
            '<img class="ss_buttonbind_icon" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/controller/button_stickleft.svg">',
            '<img class="ss_buttonbind_icon" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/controller/button_stickright.svg">',
            '<img class="ss_buttonbind_icon" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/controller/button_dpadup.svg">',
            '<img class="ss_buttonbind_icon" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/controller/button_dpaddown.svg">',
            '<img class="ss_buttonbind_icon" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/controller/button_dpadleft.svg">',
            '<img class="ss_buttonbind_icon" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/controller/button_dpadright.svg">'
        ],
        ps: [
            '<img class="ss_buttonbind_icon" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/controller/button_cross.svg">',
            '<img class="ss_buttonbind_icon" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/controller/button_circle.svg">',
            '<img class="ss_buttonbind_icon" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/controller/button_square.svg">',
            '<img class="ss_buttonbind_icon" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/controller/button_triangle.svg">',
            'LB',
            'RB',
            'LT',
            'RT',
	...
	chw: {
		...
		imgs: {
			// loot: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/chickLoop_sleep.svg',
			// speak: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/chickLoop_speak.svg',
			// limit: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/chickLoop_daily_limit.svg',
			// sleep: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/chickLoop_sleep.svg',
			// idle: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/chickLoop_idle.svg',

			idle: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/alt/cyborg/chickLoop_idle.svg',
			speak: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/alt/cyborg/chickLoop_speak.svg',
			limit: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/alt/cyborg/chickLoop_sleep.svg',
			sleep: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/alt/cyborg/chickLoop_sleep.svg',
			loot: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/alt/cyborg/chickLoop_sleep.svg',
		}
	},
    ...
    const comp_events = {
        ...
        data() {
            return {
				...
				day: 0,
				hours: 0,
				doubleEggSoonImgSrc: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/events/2XEggWeekend_cominSoon.webp',
				doubleEggLiveImgSrc: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/events/2XEggWeekend_onNow.webp',
            };
        },
        methods: {
            isEventDate(days) {
...
var comp_spinner_overlay = {
	...
	data: function () {
		return {
			...
			tips: [],
			tip: '',
			eggGuyImg: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/shellShockers_loadingTipEgg.webp',
			goodBrowser: true,
...
var comp_settings = {
	...
	data: function () {
		return {
			...
			currentRegion: '',
			icons: {
				keyboard: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_keyboard.svg',
				mouse: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_mouse.svg',
				gamePad: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_gamepad.svg',
				monitor: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_monitor.svg',
				speaker: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_speaker.svg'
			}
		}
	},
...
<script id="controls-template" type="text/x-template">
    <div id="controls_panel" class="font-700 line-height-1-2">
        ...
        <img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/tutorial/ss_tutorial_Keyboard.webp" class="tutorial-keyboard" alt="Tutorial keyboard image">
        <img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/tutorial/ss_tutorial_Mouse.webp" class="tutorial-mouse" alt="Tutorial mouse image">
    </div>
    <div class="tutorial-content display-grid align-items-center center_h">
        <div>
            <img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/tutorial/ss_tutorial_EggTarget.webp" class="tutorial-egg" alt="Tutorial egg image">
        </div>
  ...
  computed: {
    eggOrgLogo() {
      return this.playerFaction === 1
        ? 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/egg-org-red.png'
        : 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/egg-org-blue.png';
    },
	paraDescTxt() {
		if (!this.firebaseId) {
...
var comp_item = {
	...
	computed: {
		...
		bannerIconImg() {
			if (this.isPremium) {
				return 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/store/PremiumTag.webp';
			} else if (this.isVipItem) {
				return 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/store/VIPTag.webp';
			}
		},
		itemName() {
		...
		<section id="chickn-winner-wrapper" class="egg-chick-wrapper f_row roundme_lg box_relative justify-content-center">
			<div v-show="eggGameReady" class="egg-chick-box box_relative" v-for="egg in eggs" :key="egg.id">
				<div v-if="showAmountRewarded && busted && egg.value > 5" class="text-center chw-reward-amount box_absolute">
					<h2 class="box_relative shadow_grey">{{ showAmountRewarded }} <img class="chw-winner-egg" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_goldenEgg.svg" /></h2>
				</div>
...
var comp_chickn_winner_popup = {
    ...
    data: function () {
        return {
			...
			isMiniGameComplete: false,
			bustedSrc: `https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/incentivized-mini-game/svg/Egg07.svg`,
			busted: false,
			showEggGame: false,
    ...
    methods: {
		...
		eggSrc(count) {
			if (count > 6) {
				return `https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/incentivized-mini-game/svg/Egg06.svg`;
			}
		...
		eggSrcBusted() {
			setTimeout(() => {
				return `https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/incentivized-mini-game/svg/Egg07.svg`;
			}, 2424);
		},
...
<script>
    const CompChwHomeScreen = {
        ...
        data: function() {
            return {
                chest: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/chw-loot-btn.webp'
            }
        },
        methods: {
            playIncentivizedAd() {
        ...
        computed: {
            ...
            chwChickSrc() {
                if (this.chw.limitReached || this.isChicknWinnerError) {
                    // return 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/chickLoop_daily_limit.svg';
                    return this.chw.imgs.limit;
                } else {
                    if (!this.chw.ready) {
                        // return 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/chickLoop_sleep.svg';
                        return this.chw.imgs.sleep;
                    } else {
                        // return 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/chickLoop_speak.svg';
...
<script id="home-screen-template" type="text/x-template">
    <div>
		<!-- <div class="twitch-btn-wrap box_absolute">
			<button v-if="ui.events.twitch && !extern.inGame" class="ss_button twitch-btn btn_sm box_relative text-right" @click="onTwitchDropsClick">Twitch Drops Live!<span class="twitch-btn-status" v-html="isTwitchLinked"></span> <img class="box_absolute" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/twitch/img/twitch-drops-parachute.svg" alt=""></button>
		</div> -->
    ...
    var comp_create_private_game_popup = {
        ...
        methods: {
            randomMap() {
                ...
                this.mapImgPath = window.JSCDN + this.mapImgBasePath + this.map.filename + '.png?' + this.map.hash;
            },
            onRandomMapClick() {
                BAWK.play('ui_onchange');
            ...
            selectMapForPickedGameType(dir, rnd) {
                ...
                this.mapImgPath = window.JSCDN + this.mapImgBasePath + vueData.maps[idx].filename + '.png?' + vueData.maps[idx].hash;
            ...
            onMapChangeClick(idx) {
                if (idx >= 0) {
                    ...
                    this.mapImgPath = window.JSCDN + this.mapImgBasePath + this.mapList[idx].filename + '.png?' + this.mapList[idx].hash;
        ...
        computed: {
            iconSrc() {
                return this.isAnonymous ?
                    'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_goldenEgg_callout.svg' :
                    'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_goldenEgg.svg';
            },
            formattedBalance() {
    ...
    const comp_account_panel = {
        ...
        computed: {
            ...
            cgUserBtnText() {
                ...
                return {
                    ...
                    img: currentUser.profilePictureUrl || 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/crazy-games-logo.png',
            ...
            cgProfilePictureUrl() {
                if (this.crazyGamesActive) {
                    ...
                    return user?.profilePictureUrl || 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/crazy-games-logo.png';
                }
                return '';
            },
        ...
        methods: {
            createBaseState(text) {
                return {
                    text: text,
                    img: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/crazy-games-logo.png',
                    isLinked: false,
                    isLoggedIn: false
                };
            },
			...
			<div v-if="!playClicked" id="play-panel" class="box_relative">
				...
				<div class="play-panel-btn-group display-grid grid-auto-flow-column gap-1 centered_x">
					<button @click="onJoinPrivateGameClick" class="is-for-play ss_button btn_big btn_blue_light bevel_blue_light btn_play_w_friends display-grid align-items-center box_relative">
						<!-- <img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_star_gold.svg" class="icon-star top-left"/> -->
	...
	<div id="showBuyPassDialogButton" class="new">
		<div class="chicken-panel--upgraded" v-show="doUpgraded && !isSubscriber">
			<div class="tool-tip tool-tip--right">
				...
				<img class="upgraded-nugget" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/goldenNugget_static.webp">
		...
		<div class="chicken-panel--no-upgraded" v-show="!doUpgraded">
			<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/starburst.webp" @click="onChickenClick" class="clickme starburst">
			<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/chicken-nugget/goldenNuggetGIFWIP.gif" @click="onChickenClick" class="clickme nugget-chick">
		
			<div id="buyPassChickenSpeech">
				<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/speechtail.webp" class="buyPassChickenSpeechTail">
	...
	<footer class="main-footer">
		...
		<section class="centered">
			<nav class="footer-nav text-center">
				...
				<button class="ss_button_as_text" target="_blank" @click="openInNewTab('https://www.bluewizard.com')">&copy; 2026 <img class="main-footer--logo-blue-wiz-mini" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/blue-wizard-logo-tiny-min.webp" :alt="loc.footer_bluewizard + ' logo'"><span class="hideme">{{ loc.footer_bluewizard }}</span></button>
			</nav>
		</section>
	</footer>
</script>
...
<script>
    const CompHouseAd = {
		...
		data: function () {
            return {
				isVisible: true,
				portalImage: 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/free-games-io2.webp',
			...
			<div ref="content" class="player-challenge-single-content">
				...
				<div class="display-grid grid-column-2-eq align-items-center">
					<div class="player-challenge-single-reward text-shadow-black-40 display-grid align-items-center grid-column-auto-1 gap-sm">
						<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_goldenEgg.svg"> {{ reward }}
					</div>
...
<script>
    const MEDIATABS = {
        ...
        methods: {
			fetchJson() {
				extern.requestJson('https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/data/shellNews.json', (data) => {
					if (crazyGamesActive) {
				...
				extern.requestJson('https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/data/shellYouTube.json', (data) => this.youTube = data);
				extern.requestJson('https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/data/twitchStreams.json', (streams) => {
...
<script>
    ...
    <div id="screens-menu" v-if="isGamePaused" class="screens-menu box_relative">
		...
		<div id="logo" class="box_relative">
			...
			<!-- <img v-if="eggOrg" class="egg-org-logo" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/egg-org/logo_EggOrg.svg"> -->
		</div>
		<transition name="fade">
		...
		<div id="faction-meter" class="faction-meter centered_x" @click="onFactionMeterClick">
			...
			<div class="faction-meter-shell ss-shell-meter centered_x">
				<div id="ss-shell-gauge" class="gauge">
					<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/shadows-meter.png" class="centered_x meter-gauge">
					<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/red-glow.png" class="glow red" v-if="leadingFaction === 0">
					<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/blue-glow.png" class="glow blue" v-if="leadingFaction === 1">
					<div ref="needle" class="needle">
						<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/meter_marker.png" class="centered_x">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="faction-labels centered_x bottom-0 tool-tip">
			...
			<div class="tool-tip">
				<div class="faction-label faction-1-label f_row align-items-center justify-content-center roundme_sm" 
					...
					<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/ico_crossbones.svg" alt=""> 
        ...
        computed: {
            ...
            twitchDropsBtnImgSrs() {
                if (this.twitchLinked) {
                    return 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/../img/events/twitch-drops-btn-linked.webp';
                }
                return 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/../img/events/twitch-drops-btn-link-now.webp';
            },
            isTwitchLinked() {
		...
		<small-popup id="buyItemPopup" ref="buyItemPopup" @popup-confirm="onBuyItemConfirm" @popup-closed="onBuyItemClose" :hideCancel="abTestInventory.enabled" :hideClose="abTestInventory.enabled" :overlayClose="!abTestInventory.enabled">
			...
			<template slot="content">
				...
				<div class="f_row f_center">
					<img v-if="!isBuyingItemPrem" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_goldenEgg.webp" class="egg_icon"/>
			...
			<template slot="content">
				<div v-if="(equip.physicalUnlockPopup.item !== null)">
					<div>
						...
						<div class="f_row f_center">
							<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_goldenEgg.webp" class="egg_icon"/>
			...
			<template slot="content">
				<div id="hvsm-popup-item-grid-wrap" v-show="isOnEquipModeFeatured || isEquipModeShop" class="hvsm-popup-item-grid-wrap paddings_lg display-grid  grid-auto-flow-column align-items-center justify-content-center">
					<div class="hvsm-popup-item-grid">
						<header>
							<img class="display-block center_h" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/shell_E&E_good_popup.webp" alt="Heroes logo">
					...
					<div class="hvsm-popup-item-grid">
						<header>
							<img class="display-block center_h" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/shell_E&E_evil_popup.webp" alt="Monsters logo">
	...
	<div>
		...
		<div id="equip_equippedslots">
			<div class="equip_item roundme_lg clickme f_row f_center" @click="onClick(itemType.Primary)">
				...
				<div v-if="!primaryItem" class="equip_icon equip_icon_hat equip_icon_no_item"><img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/inventory-icons/ico_weaponPrimary.svg" alt="Primary equip slot"></div>
			</div>
			...
			<div class="equip_item roundme_lg clickme f_row f_center" @click="onClick(itemType.Secondary)">
				...
				<div v-if="!secondaryItem" class="equip_icon equip_icon_hat equip_icon_no_item"><img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/inventory-icons/ico_weaponSecondary.svg" alt="Secondary equip slot"></div>
			</div>
			...
			<div class="equip_item roundme_lg clickme f_row f_center" @click="onClick(itemType.Grenade)">
				...
				<div v-if="!grenadeItem" class="equip_icon equip_icon_hat equip_icon_no_item"><img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/inventory-icons/ico_grenade.svg" alt="Grenade equip slot"></div>
			...
			<div class="equip_item roundme_lg clickme f_row f_center" @click="onClick(itemType.Hat)">
				...
				<div v-if="!hatItem" class="equip_icon equip_icon_hat equip_icon_no_item"><img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/inventory-icons/ico_hat.svg" alt="Hat item slot"></div>
			</div>
			...
			<div class="equip_item roundme_lg clickme f_row f_center" @click="onClick(itemType.Stamp)">
				...
				<div v-if="!stampItem" class="equip_icon equip_icon_stamp equip_icon_no_item"><img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/inventory-icons/ico_stamp.svg" alt="Stamp item slot"></div>
			</div>
		</div>
	</div>
</script>
	...
	<div class="text-center egg-color-select roundme_sm common-box-shadow">
		...
		<div id="equip_free_colors" class="display-grid text-center grid-auto-flow-column align-items-center ">
			...
			<span v-for="(c, index) in freeColors" class="box_relative roundme_sm egg-color-icon " @click="onClick(index)">
				<img v-if="index === colorIdx" class="centered_x color-select-arrow" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico-arrow-colorPicker.svg"/>
		...
		<div id="equip_paid_colors" class="display-grid text-center grid-auto-flow-column align-items-center "> -->
			...
			<span v-for="(c, index) in paidColors" class="box_relative roundme_sm egg-color-icon" @click="onClick(index + freeColors.length)">
				<img v-if="colorIdx === (index + freeColors.length)" class="centered_x color-select-arrow" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico-arrow-colorPicker.svg"/>
...
var comp_item_timer = {
    ...
    <div id="equip_purchase_items" v-if="isNoPrice" class="equip_purchase_items box_relative">
		...
		<button v-if="!playerNeedsMoreEggs && !isItemOwned" class="ss_button btn_green bevel_green btn_md btn_buy_item display-grid fullwidth font-nunito f_row align-items-center justify-content-center box_relative" @click="onBuyClick">
			{{priceTagText}}
			<img v-if="!isPremium" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_goldenEgg.webp" class="ss_marginright_sm ss_marginleft">
...
<script>
	...
	<div id="equip_get_physical_item" class="equip_purchase_items">
		<div id="equip_pricetag" class="equip_pricetag shadow_blue2">
			<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/pricetag_left.webp">
			<div class="equip_pricetag__tag equip_pricetag__is_special_tag">
				<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_goldenEgg.webp" class="ss_marginright">{{ loc.p_buy_special_price }}
			</div>
			<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/pricetag_right.webp">
		</div>
        ...
        <div class="display-grid align-items-center text-center" :class="headerGrid">
            ...
            <div class="single-egg-store-wrapper">
                ...
                <div class="single-egg-store-price box_relative z-index-2">
                    <img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/store/passes/pass_welcome_title.png" v-if="productTypePass" class="pass-title-img">
...
<script>
    const comp_store_item = {
        ...
        computed: {
            ...
            style() {
                return this.productTypePass ? `background-image: url(${window.JSCDN}img/store/passes/${this.item.sku}_bg.png); background-size: cover;` : '';
            },
            img() {
				console.log('Store item type:', this.item.type);
				const imgDir = 'img/';
				const ImgPath = window.JSCDN + imgDir || imgDir;
				console.log('donkeyRising cdn', ImgPath);
                switch (this.item.type) {
                    case 'item':
						const itemImgPath = `${ImgPath}store/items/${this.item.sku}.webp`;
						console.log('Item image path:', itemImgPath);
                        return itemImgPath;
                        break;
                    case 'bundle':
						const bundleImgPath = `${ImgPath}store/bundles/${this.item.sku}.webp`;
						console.log('Bundle image path:', bundleImgPath);
                        return bundleImgPath;
                        break;
                    case 'pass':
						const passImgPath = `${ImgPath}store/passes/${this.item.sku}.png`;
						console.log('Pass image path:', passImgPath);
                        return passImgPath;
                        break;
					case 'currency':
						const currencyImgPath = `${ImgPath}${this.item.sku}.webp`;
						console.log('Currency image path:', currencyImgPath);
						return currencyImgPath;
						break;
                    default:
                        return `${ImgPath}${!this.isSaleEvent ? '' : 'store-black-friday/'}${this.item.sku}.webp`;
                        break;
                }
            },
            itemType() {
		...
		<div ref="gameUIWrapper">
			<div ref="gameUiInner" class="paused-game-ui z-index-1 centered_x fullwidth" v-show="showScreen === screens.game">
				<!-- <div class="factions-game-score centered_x">
					<div class="faction-label faction-0-label f_row align-items-center justify-content-center roundme_sm box_absolute right-0 tool-tip"><span class="tool-tip-text faction-tooltip">{{ loc.factions_in_game_tip.format(loc.faction_b_title) }}</span><img class="faction-game-logo box_absolute" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/faction-egg-masters.png" alt=""><img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/ico_crossbones.svg" alt=""> <i class="display-block">{{ factionsBGameScore }}</i></div>
					<div class="faction-label faction-1-label f_row align-items-center justify-content-center roundme_sm box_absolute left-0 tool-tip"><span class="tool-tip-text faction-tooltip">{{ loc.factions_in_game_tip.format(loc.faction_a_title) }}</span><img class="faction-game-logo box_absolute" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/faction-egg-assasins.png" alt=""><img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/ico_crossbones.svg" alt=""> <i class="display-block">{{ factionsAGameScore }}</i></div>
				</div> -->
<!-- 
				...
				<div id="teamScores" class="centered_x display-grid grid-auto-flow-column align-items-center gap-sm">
					...
					<!--<div>
							<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/spatulaIcon.webp" style="width: 3em; transform: rotate(60deg)">
					</div>-->
				</div>
					...
					<div ref="captureIconContainer" id="captureIconContainer">
						<div id="captureInsideContainer">
							...
							<svg id="captureIcon" viewBox="0 0 53.6 36">
								<use href="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/crown.svg#crown" />
							</svg>
						</div>
					</div>
				</div>
				...
				<div id="captureContainer">
					<div class="captureScoreContainer">
						<svg class="captureCrown" viewBox="0 0 53.6 36">
							<use href="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/crown.svg#crown" fill="var(--ss-team-red-light)" />
						</svg>
					...
					<div class="captureScoreContainer">
						<svg class="captureCrown" viewBox="0 0 53.6 36">
							<use href="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/kotc/crown.svg#crown" fill="var(--ss-team-blue-light)" />
						</svg>
				...
				<div id="weaponBox">
					<div id="grenades">
						<img id="grenade3" class="grenade" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_grenadeEmpty.webp?v=1"/>
						<img id="grenade2" class="grenade" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_grenadeEmpty.webp?v=1"/>
						<img id="grenade1" class="grenade" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_grenadeEmpty.webp?v=1"/>
					</div>
					<h2 id="weaponName"></h2>
				...
				<div id="kill-death-box" ref="killDeathBox" v-show="game.ingameNotification.showing" class="in-game-notification centered_x">
					<img v-show="game.ingameNotification.item.type !== 2" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/ico_streak.webp" alt="" class="centered_x kill-death-box-img" />
...
<script>
    var comp_game_screen = {
        ...
        computed: {
            ...
            upgradeBadgeUrl() {
                return 'https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/vip-club/vip-club-popup-emblem.webp';
            },
            playerSocial() {
	...
	<div data-html2canvas-ignore>
		<div class="box_relative margins_lg screens-menu" :class="{'phb-active-bg' : bgIdx}">
			<div v-show="uiActive">
				<h3 class="pb-title text-center text_white display-grid grid-auto-flow-column justify-content-center gap-sm text-shadow-black-40"><img class="pb-title-img" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/photo-booth/ico_shelfieStars.svg" />Shellfie<br /> Booth <img class="pb-title-img pb-title-img-flip"src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/photo-booth/ico_shelfieStars.svg" /></h3>
            ...
            <div class="vip-club--content">
                <div class="subs-info">
                    <ul class="display-grid align-content-space-between">
                        <li class="display-grid align-items-start"><img class="vip-club-star" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/vip-club/vip-club-popup-bullet-point-star.webp" alt="star-list-img">{{loc.p_chicken_goldfeature1}}</li>
                        <li class="display-grid align-items-start"><img class="vip-club-star" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/vip-club/vip-club-popup-bullet-point-star.webp" alt="star-list-img"> <span v-html="loc.p_chicken_goldfeature3"></span></li>
                        <li class="display-grid align-items-start"><img class="vip-club-star" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/vip-club/vip-club-popup-bullet-point-star.webp" alt="star-list-img"><span v-html="eggsPerKill"></span></li>
                        <li class="display-grid align-items-start"><img class="vip-club-star" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/vip-club/vip-club-popup-bullet-point-star.webp" alt="star-list-img"> {{loc.s_popup_feature_premium_items}}</li>
						<li class="display-grid align-items-start"><img class="vip-club-star" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/vip-club/vip-club-popup-bullet-point-star.webp" alt="star-list-img"> {{loc.s_popup_feature_premium_stamp_pos}}</li>
						<li class="display-grid align-items-start"><img class="vip-club-star" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/vip-club/vip-club-popup-bullet-point-star.webp" alt="star-list-img"> {{loc.s_popup_and_more}}</li>
                    </ul>
                </div>
            </div>
        </div>
...
var compVipClubTemplate = {
    ...
    computed: {
		...
		eggsPerKill() {
			return this.loc.p_chicken_goldfeature2.format('<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_goldenEgg.svg" />');
		},
		hasActivePass() {
			...
			<section>
				...
				<!-- <div v-show="(notification.data.eggs) && eggsActive" class="notify-group notify-group-eggs f_col justify-content-center roundme_lg box_relative" :class="eggPackClass(notify.data.eggs)">
					...
					<div class="egg-give-stuff">
						...
						<img  src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/egg_pack_small.webp" />
						<h2><img class="vertical-align-middle width_1 egg-img" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_goldenEgg.svg" />{{notify.data.eggs}}</h2>
...
<script id="notification-slider" type="text/x-template">
	<div v-if="type" class="notify-group notify-group-items f_col justify-content-center roundme_lg box_relative" :class="clsType">
		<img v-if="type === 'eggOrg'" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/gauge-bar/egg-org-red.png" class="centered_x factions-egg-org-logo">
		<header>
	...
	<div v-if="chlg.length > 0">
		<div v-for="(i, idx) in chlg" v-show="idx === notifyIdx">
			...
			<div class="account_eggs roundme_sm clickme f_row justify-content-center ss_margintop_lg ss_marginbottom_lg">
				<span class="egg_count text-center text-shadow-black-40"><img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_goldenEgg.svg" class="egg_icon"> {{ i[2] }}</span>
			</div>
		</div>
	</div>
	<!-- challenges -->
...
<script>
	...
	<div class="egg-give-stuff">
			<img  src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/egg_pack_small.webp" />
			<h2><img class="vertical-align-middle width_1 egg-img" src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_goldenEgg.svg" />{{eggs}}</h2>
		</div>
</script>
        ...
        vueApp = new Vue({
            ...
            methods: {
                ...
                showHistoryChangelogPopup() {
                    fetch('https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/changelog/oldChangelog.json', {
                            cache: "no-cache"
                        })
            ...
            computed: {
                ...
                anonPopupContent() {
                    return this.loc.account_anon_warn_paragraph_block.format('<img src="https://cdn.jsdelivr.net/gh/shellbros/shellbros.github.io@6bf9789/img/svg/ico_goldenEgg.svg" class="egg_icon" />');
                },
                chwShowBtn() {
